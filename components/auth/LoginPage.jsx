  ...
  return (
    <div className="min-h-screen flex theme-soft text-foreground relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Gradient orbs */}
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-gradient-to-br from-sky-300/40 to-emerald-200/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-gradient-to-br from-amber-200/40 to-orange-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-0 right-1/3 w-72 h-72 bg-gradient-to-br from-sky-200/30 to-blue-200/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className={`absolute transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <BookOpen className="absolute top-[15%] left-[10%] w-8 h-8 text-sky-400/40 animate-float" style={{ animationDelay: '0s' }} />
          <GraduationCap className="absolute top-[25%] right-[15%] w-10 h-10 text-amber-400/35 animate-float" style={{ animationDelay: '1s' }} />
          <Pencil className="absolute bottom-[30%] left-[20%] w-6 h-6 text-emerald-400/35 animate-float" style={{ animationDelay: '2s' }} />
          <Award className="absolute top-[60%] left-[8%] w-8 h-8 text-amber-400/30 animate-float" style={{ animationDelay: '0.5s' }} />
          <Calendar className="absolute bottom-[20%] right-[25%] w-7 h-7 text-sky-400/30 animate-float" style={{ animationDelay: '1.5s' }} />
          <ClipboardCheck className="absolute top-[40%] right-[8%] w-9 h-9 text-emerald-400/25 animate-float" style={{ animationDelay: '2.5s' }} />
        </div>
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(15,23,42,.08) 1px, transparent 1px), linear-gradient(90deg, rgba(15,23,42,.08) 1px, transparent 1px)`,
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-16">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-sky-400 to-emerald-300 rounded-2xl blur-lg opacity-50" />
              <img
                src="/logo.png"
                alt="My Academy Logo"
            ...
            <div>
              <h1 className="text-4xl font-bold text-slate-900 tracking-tight">My Academy</h1>
              <p className="text-slate-500 text-sm font-medium tracking-wide">School Management System</p>
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-5xl font-bold text-slate-900 leading-tight mb-4">
              Empowering<br />
              <span className="bg-gradient-to-r from-sky-500 to-emerald-400 bg-clip-text text-transparent">Education</span><br />
              Through Technology
            </h2>
      ...
      <div className={`flex-1 flex items-center justify-center p-6 lg:p-12 relative z-10 transition-all duration-700 delay-300 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
        <div className="w-full max-w-md">
          ...
          {/* Login Card */}
          <Card className="border-0 soft-surface overflow-hidden">
            ...
            <CardContent className="p-8 lg:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-sky-300/20 to-emerald-200/20 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity" />
                    <div className="relative">
                      <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-slate-400 group-focus-within:text-sky-500 transition-colors" />
                      <Input
                        id="email"
                        type="email"
                        ...
                        className="pl-12 h-14 bg-white/80 border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-sky-400/60 focus:ring-sky-200/60 rounded-xl transition-all"
                        required
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-sky-300/20 to-emerald-200/20 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity" />
                    <div className="relative">
                      <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-slate-400 group-focus-within:text-sky-500 transition-colors" />
                      <Input
                        id="password"
                        ...
                        className="pl-12 pr-12 h-14 bg-white/80 border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-sky-400/60 focus:ring-sky-200/60 rounded-xl transition-all"
                        required
                      />
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-sky-500 focus:outline-none transition-colors"
                      >
                        {showPassword ? (
                ...
                {/* Error Message */}
                {error && (
                  <div className="p-4 bg-rose-50 border border-rose-200 rounded-xl animate-shake">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-14 bg-gradient-to-r from-sky-500 to-emerald-400 hover:from-sky-600 hover:to-emerald-500 text-on-accent font-semibold text-base shadow-lg shadow-sky-200/70 hover:shadow-xl hover:shadow-emerald-200/70 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl group"
                >
                  {isLoading ? (
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center">
                  <span className="px-4 text-sm text-slate-400 bg-white/70">
                    Secure Login
                  </span>
                </div>
              </div>
