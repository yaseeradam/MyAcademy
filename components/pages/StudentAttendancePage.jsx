      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={showAttendanceModal} onOpenChange={setShowAttendanceModal}>
          ...
          <DialogContent className="max-w-5xl max-h-[90vh]">
            <DialogHeader>
              <DialogTitle className="text-xl">Mark Student Attendance</DialogTitle>
              <DialogDescription>Select class and date to mark attendance for students.</DialogDescription>
            </DialogHeader>
                  ...
                  {attendanceList.length === 0 ? (
                    ...
                    <>
                      <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
                        <h3 className="font-semibold text-lg">{attendanceList.length} Students</h3>
                      ...
                      <div className="max-h-[400px] overflow-y-auto space-y-2 pr-2">
                        {attendanceList.map((item, index) => (
                          <div key={item.studentId} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
