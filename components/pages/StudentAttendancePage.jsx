      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={showAttendanceModal} onOpenChange={setShowAttendanceModal}>
          ...
          <DialogContent className="w-[95vw] max-w-5xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden">
            <DialogHeader>
              <DialogTitle className="text-lg sm:text-xl">Mark Student Attendance</DialogTitle>
              <DialogDescription className="text-sm">Select class and date to mark attendance for students.</DialogDescription>
            </DialogHeader>
                  ...
                  {attendanceList.length === 0 ? (
                    ...
                    <>
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-gray-50 p-3 sm:p-4 rounded-lg gap-3">
                        <h3 className="font-semibold text-base sm:text-lg">{attendanceList.length} Students</h3>
                      ...
                      <div className="max-h-[400px] overflow-y-auto space-y-3 pr-2">
                        {attendanceList.map((item, index) => (
                          <div key={item.studentId} className="p-3 sm:p-4 border rounded-lg hover:bg-gray-50 transition-colors">
