...
export default function MasterSettingsPage({ masterSettings, setMasterSettings, handleSaveMasterSettings, stats }) {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900">Master Settings</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-slate-700">System Name</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label className="text-slate-700">System Email</Label>
                  <Input
                    type="email"
          ...
          <Card className="border border-slate-200/70 bg-white/80 backdrop-blur-xl">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-slate-700">Max Schools</Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-2">
                  <Label className="text-slate-700">System Version</Label>
                  <Input
                ...
                <div className="flex items-center space-x-3 pt-6 col-span-1 md:col-span-2">
                  ...
                  />
                  <Label htmlFor="allowRegistration" className="text-slate-700">Allow New School Registration</Label>
                </div>
                <div className="flex items-center space-x-3 col-span-1 md:col-span-2">
                  ...
                  />
                  <Label htmlFor="maintenanceMode" className="text-slate-700">Maintenance Mode</Label>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <Card className="border border-slate-200/70 bg-white/80 backdrop-blur-xl">
        <CardHeader className="border-b border-slate-200/70">
          <CardTitle className="text-slate-900">System Statistics</CardTitle>
          <CardDescription className="text-slate-500">Current system usage and metrics</CardDescription>
        </CardHeader>
        <CardContent className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-white/80 rounded-xl border border-slate-200/70">
              <div className="p-2.5 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl w-fit mx-auto mb-3">
                <Building2 className="h-5 w-5 text-white" />
              </div>
              <div className="text-2xl font-bold text-slate-900">{stats.totalSchools || 0}</div>
            ...
            <div className="text-center p-4 bg-white/80 rounded-xl border border-slate-200/70">
              ...
              <div className="text-2xl font-bold text-slate-900">{stats.activeSchools || 0}</div>
