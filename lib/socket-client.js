...
class SocketManager {
  ...
  connect(token) {
    ...
    const cleanedToken = typeof token === 'string'
  ...
  setupEventListeners() {
    ...
    this.socket.on('connect_error', (error) => {
      ...
      this.isConnected = false
      // Surface the error to React listeners (e.g., broadcast dialog)
      this.emit('error', (error && error.message) ? error.message : 'Connection error')
